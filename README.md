...
![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/7c4e00e5-6570-43bd-911b-1bd366824e80/Untitled.png)

![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/e72c0283-4ce6-4822-a467-b2564d3de8e3/Untitled.png)
...
- /{blog-address} : user 이름, 이웃 숫자, 대문사진  /   게시글 목록 JSON
    ...
    ![blogpeople.png](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/52bdf72e-8a61-4132-ad19-a52e7fdc8ef0/blogpeople.png)
    
    : 기본 화면. ‘blopeople’의 블로그 게시글 2가지의 목록을 보여줍니다.  
    
- /{blog-address}/post/{post-id} / 게시글 JSON
    
    ![blogpeople_post_1.png](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/d5bf1444-bf92-4b0a-9939-6303b799cab3/blogpeople_post_1.png)
    
     : 원하는 블로그 유저의 게시물 하나를 보여줍니다. → “blogpeopl”의 “1”번 게시물  
    
- /{blog-address}/post/{post-id}/like / 게시글 좋아요
    
    ![blogpeople_post_1_like.png](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/c4038755-d915-4060-bc7b-9ce9a9e0bb0e/blogpeople_post_1_like.png)
    
    : 게시물의 “likes”항목에서 게시글의 좋아요를 확인할 수 있습니다.
    
- /{blog-address}/post/{post-id}/comment / 댓글 가져오기
    
    ![blogpeople_post_1_comment.png](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/7e0962b1-f941-417b-b9be-990df8e798e4/blogpeople_post_1_comment.png)
...
- /{blog-address}/post/{post-id}/comment / 댓글 등록
    ...
    ![5_goodjob.png](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/d7440221-88e5-4623-b14b-33bb5013a4b6/5_goodjob.png)
...
- /{blog-address}/post/{post-id}/comment/like/{comment-id} /댓글에 좋아요
    ...
    ![blogpeople_post_1_comment_like_1.png](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/bffe855b-e433-4a0b-b117-aee93f0540bd/blogpeople_post_1_comment_like_1.png)
...
- 1. github로 협업
    ...
    ![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/d441911a-67f7-4310-b105-d9e593b2f52b/Untitled.png)
    
    ![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/97518ec5-2fff-4791-aa4c-a5903408fa09/Untitled.png)
