...
<!--
이건 개인 취향일 것 같아요!
post, comment, user 각각 그 안에 각자의 controller와 service를 가지는 것도 좋아보입니당!

처음 보았을 때 service 폴더가 어떤 역할을 하는 지 잘 모르겠다는 생각을 했어요.
lib 라던가, support 같은 명칭을 가지고 있다면 더 명확할 것 같아요!
-->
